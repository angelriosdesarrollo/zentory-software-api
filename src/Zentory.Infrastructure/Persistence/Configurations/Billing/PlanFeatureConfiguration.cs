...
public class PlanFeatureConfiguration : IEntityTypeConfiguration<PlanFeature>
{
    public void Configure(EntityTypeBuilder<PlanFeature> builder)
    {
        ...
        builder.Property(f => f.LegalType).HasColumnName("legal_type").HasMaxLength(20).IsRequired();
        ...
        builder.HasIndex(f => new { f.PlanId, f.LegalType, f.SortOrder }).HasDatabaseName("ix_plan_features_lookup");
    }
}
