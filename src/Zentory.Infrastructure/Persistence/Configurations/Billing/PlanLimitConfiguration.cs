...
public class PlanLimitConfiguration : IEntityTypeConfiguration<PlanLimit>
{
    public void Configure(EntityTypeBuilder<PlanLimit> builder)
    {
        ...
        builder.Property(l => l.AccountType).HasColumnName("account_type").HasMaxLength(20).IsRequired();
        ...
        builder.HasIndex(l => new { l.PlanId, l.AccountType, l.FeatureKey }).IsUnique().HasDatabaseName("ix_plan_limits_plan_account_feature");
    }
}
