...
public class PlanMarketingConfiguration : IEntityTypeConfiguration<PlanMarketing>
{
    public void Configure(EntityTypeBuilder<PlanMarketing> builder)
    {
        ...
        builder.Property(m => m.LegalType).HasColumnName("legal_type").HasMaxLength(20).IsRequired();
        ...
        builder.Property(m => m.UpdatedAt).HasColumnName("updated_at");
        builder.HasIndex(m => new { m.PlanId, m.LegalType }).IsUnique().HasDatabaseName("ix_plan_marketing_plan_account");
    }
}
